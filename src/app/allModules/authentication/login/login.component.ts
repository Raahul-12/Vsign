...
export class LoginComponent implements OnInit {
    ...
    SettingsSubChildren: FuseNavigation[] = [];
    showall: FuseNavigation[] = [];
    ...
    vsignUserChildren: FuseNavigation[] = [];
    ...
    GetUserMenus(): void {
        ...
        if (this.menuItems.indexOf("vsign-reposting") >= 0) {
            this.children.push({
                id: "reposting",
                title: "Reposting",
                translate: "NAV.VENDOR.DASHBOARD",
        ...
        if (this.menuItems.indexOf("vsign-classification") >= 0) {
            this.children.push({
                id: "classification",
                title: "Classification",
                translate: "NAV.VENDOR.DASHBOARD",
    ...
    settingsMenus(): void {
        if (this.menuItems.indexOf("OrderFulFilmentCenter") >= 0) {
            this.SettingsSubChildren.push({
                id: "fulfilmentCenter1",
    ...
    GetAdminMenus(): void {
        ...
        if (this.menuItems.indexOf("App") >= 0) {
            this.children.push({
                id: "orderfulfilmentCenter1",
                title: "Settings",
                type: "collapsable",
                isSvgIcon: true,
                icon: 'settingsIcon',
                children: this.SettingsSubChildren,
            });
